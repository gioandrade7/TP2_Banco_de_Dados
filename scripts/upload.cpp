...
int main(int argc, char *argv[])
{
    ...
    string dataFilePath = "dataFile.bin";
    ...
    while (true)
    {
        ...
        if (get_next_field(arquivo, field, pattern))
            break;
        id = stoi(field);
    ...
    cout << "Inserção dos registros no arquivo de dados e criação dos índices concluída!" << endl
         << endl;

    // Criando os arquivos de índices
    FILE *indexFile1, *indexFile2;
    indexFile1 = fopen("indexFile1.bin", "wb+");
    indexFile2 = fopen("indexFile2.bin", "wb+");
